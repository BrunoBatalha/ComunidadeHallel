...
<html lang="pt-br">
    ...
    <div class="row" style="height: 100%">
        ...
        <div class="col-md-3 painel" style="height: 100%;">

            <img alt="foto" src="rsc/img/avatar2.png" class="objectImage2 perfil">
            <br><br>
            ...
            <br><br><br>
            <a href="#"><button type="button" class="btn btn-dark" data-toggle="modal" data-target="#sair">Sair</button>
            </a>

        </div>

        <div class="col-md-9 exibicao ">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="sair">Deseja mesmo sair?</h5>
                ...
                <div class="modal-footer">
                    ...
                    <a href="index.html"><button type="button" class="btn btn-primary">Sair</button></a>
                </div>
            </div>
        </div>
    </div>
